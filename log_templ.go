	...
	return templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
		...
		for _, log := range m.Logs {
			...
			if m.Config.Expand != log.Hash() && !m.DisableActions {
				...
				var templ_7745c5c3_Var10 templ.SafeURL = m.Config.WithExpand(log.Hash()).Query().ToLink()
				...
				var templ_7745c5c3_Var12 templ.SafeURL = m.Config.WithExpand(0).Query().ToLink()
			...
			if m.Config.Expand != log.Hash() && !m.DisableActions {
				...
				var templ_7745c5c3_Var15 templ.SafeURL = m.Config.WithExpand(log.Hash()).Query().ToLink()
				...
				var templ_7745c5c3_Var17 templ.SafeURL = m.Config.WithExpand(0).Query().ToLink()
		...
		if len(m.Logs) == m.Limit && !m.Config.AutoRefresh && !m.DisablePagination {
			...
			_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(m.Config.WithBeforeHash(m.Logs[len(m.Logs)-1].Hash()).Query().ToLinkString()))
			if templ_7745c5c3_Err != nil {
				return templ_7745c5c3_Err
			}
			...
			templ_7745c5c3_Var25 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
				...
				templ_7745c5c3_Var26 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
					...
					if m.Config.AutoRefresh {
						...
						_, templ_7745c5c3_Err = templ_7745c5c3_Buffer.WriteString(templ.EscapeString(m.Config.Query().ToLinkString()))
						if templ_7745c5c3_Err != nil {
							return templ_7745c5c3_Err
						}
						...
						var templ_7745c5c3_Var28 templ.SafeURL = m.Config.Query().Add(llAutoRefreshKey, "true").ToLink()
						...
						var templ_7745c5c3_Var29 templ.SafeURL = m.Config.Query().ToLink()
				...
				templ_7745c5c3_Var31 := templ.ComponentFunc(func(ctx context.Context, templ_7745c5c3_W io.Writer) (templ_7745c5c3_Err error) {
					...
					for verdict := range data.NumLogVerdicts {
						...
						if m.Config.Filter == verdict {
							...
							if templ_7745c5c3_Err != nil {
								return templ.Error{Err: templ_7745c5c3_Err, FileName: `log.templ`, Line: 132, Col: 51}
							}
							...
							var templ_7745c5c3_Var34 templ.SafeURL = m.Config.Query().Add(llFilterKey, strconv.Itoa(verdict)).ToLink()
